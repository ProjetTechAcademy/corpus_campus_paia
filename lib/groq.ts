...
export async function generateRevisionPartWithGroq(input: {
  ...
  return chat(
    [
      ...
      "Si la source interne emploie une ancienne appellation ou une ancienne règle encore compréhensible, conserve-la seulement comme repère historique et indique immédiatement l'appellation ou la règle actuelle.",
      OFFICIAL_SOURCE_RULES_FR,
